<template>
  <div class="w-full">
    <!-- Hero section -->
    <section id="hero" class="w-full pb-60">
      <BaseSection>
        <div class="col-span-12 lg:col-span-6 mt-12 xl:mt-10 space-y-4 sm:space-y-6 px-6 text-center sm:text-left">
          ...
          <h1
            data-aos="fade-right"
            data-aos-once="true"
            class="text-[3.5rem] sm:text-6xl xl:text-7xl font-bold leading-tight capitalize sm:pr-8 xl:pr-10"
          >
            Blockchain compliance made easy
          </h1>
          <p data-aos="fade-down" data-aos-once="true" data-aos-delay="300" class="paragraph hidden sm:block">
            Automate your compliance procedures  and avoid million-dollar fines with the most intuitive and sophisticated compliance toolkit ever built. 
          </p>
          <div
            data-aos="fade-up"
            data-aos-once="true"
          ...
          >
            <BaseButton
              class="max-w-full px-8 py-4 bg-gradient-to-r from-[#12d8fa] to-[#a6ffcb] text-white"
            >
              <strong>Get Started</strong>
            </BaseButton>
            <BaseButton
              class="max-w-full px-6 py-4 bg-inherit text-gradient flex items-center justify-center"
            >
              <strong><span>Contact Sales</span></strong>
              <ChevronDownIcon :size="20" class="mt-1 text-[#12d8fa]" />
            </BaseButton>
          </div>
        </div>
        <div class="hidden sm:block col-span-12 lg:col-span-6">
          <div class="w-full">
            <img
              data-aos="fade-up"
              data-aos-once="true"
              :src="require('~/assets/img/baseimg.svg')"
            class="mt-6"
              alt=""
            />
          </div>
